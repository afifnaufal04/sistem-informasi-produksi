...
@section('content')
    <div class="container mx-auto px-4">
        ...
        @if (session('success'))
            ...
            <meta http-equiv="refresh" content="1;url={{ route('keprod.pemesanan.index') }}">
        @endif
        ...
        <div class="mb-6 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            <form action="{{ route('keprod.pemesanan.index') }}" method="GET" class="space-y-4">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex gap-3">
                            <a href="{{ route('keprod.pemesanan.show', $pemesanan->pemesanan_id) }}"
