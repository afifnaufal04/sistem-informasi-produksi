...
<div class="mx-2 flex justify-start space-x-2 mb-4">
    ...
    <a href="{{ route('keprod.pemesanan.downloadspk', $pemesanan->pemesanan_id) }}" 
        class="bg-red-500 hover:bg-red-700 text-white font-medium px-4 py-2 rounded shadow">
        Download SPK
    </a>

    <form action="{{ route('keprod.pemesanan.konfirmasi', ['id' => $pemesanan->pemesanan_id, 'bagian' => 'keprod']) }}" method="POST">
        @csrf
