...
<div class="container mx-auto px-6 w-full py-6">
    ...
    <form action="{{ route('marketing.barang.update', $barang->barang_id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-2xl shadow-lg space-y-6 max-w-5xl mx-auto">
        @csrf
        @method('PUT')
