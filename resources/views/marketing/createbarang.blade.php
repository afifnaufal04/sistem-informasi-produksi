...
<div class="container mx-auto px-6 w-full py-6">
    <h1 class="text-3xl text-center font-bold">Tambah Barang</h1>
    <p class="text-sm text-center text-gray-500 mb-6">Isi detail barang dan unggah gambar untuk katalog</p>

    <form action="{{ route('marketing.barang.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-2xl shadow-lg space-y-6 max-w-5xl mx-auto">
        @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="jenis_barang" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-200 focus:border-green-400" required>
                            ...
                            <option value="diy" {{ old('jenis_barang') == 'diy' ? 'selected' : '' }}>DIY</option>
                            <option value="superindo" {{ old('jenis_barang') == 'superindo' ? 'selected' : '' }}>Superindo</option>
                            <option value="pendopo" {{ old('jenis_barang') == 'pendopo' ? 'selected' : '' }}>Pendopo</option>
                            <option value="ooa" {{ old('jenis_barang') == 'ooa' ? 'selected' : '' }}>OOA</option>
                        </select>
                        @error('jenis_barang')
                            <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="number" name="harga_barang" value="{{ old('harga_barang') }}" 
                                class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-200 focus:border-green-400" 
                        ...
                        <div>
                            ...
                            <input type="number" name="stok_gudang" value="{{ old('stok_gudang', 0) }}" 
                                class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-200 focus:border-green-400" 
                                placeholder="0" min="0">
                            @error('stok_gudang')
                                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div>
                                ...
                                <input type="number" step="0.01" name="panjang" value="{{ old('panjang') }}" 
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="lebar" value="{{ old('lebar') }}" 
                                    class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-green-200 focus:border-green-400" 
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="tinggi" value="{{ old('tinggi') }}" 
                                    class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-green-200 focus:border-green-400" 
                ...
                <div class="space-y-4">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center text-center hover:border-green-400 transition" id="imageUploadContainer">
                        <div class="w-48 h-48 rounded-md overflow-hidden bg-gray-50 flex items-center justify-center mb-3 border border-gray-200">
                            <img id="previewImage" src="{{ asset('images/placeholder-image.png') }}" alt="Preview" class="w-full h-full object-contain" />
                        </div>
        ...
        <div class="border-b pb-6">
            ...
            <div id="bahanContainer" class="space-y-4">
                {{-- Template akan di-clone oleh JavaScript --}}
                ...
                <div class="flex">
                    ...
                    <div class="text-xs text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1 ml-2">
                            ...
                            <li>PPIC dapat menambahkan atau mengubah bahan pendukung nanti melalui menu <strong>Edit Barang</strong></li>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t">
            <a href="{{ route('marketing.daftarbarang') }}" class="inline-flex items-center gap-2 bg-gray-200 hover:bg-gray-300 px-6 py-2.5 rounded-lg text-sm text-gray-700 font-medium transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const firstItem = document.querySelector('.bahan-item');
    let itemCounter = 1;
