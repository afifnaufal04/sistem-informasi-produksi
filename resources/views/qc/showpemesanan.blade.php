...
<div class="container mx-auto px-4">
    ...
    @if (session('success'))
        ...
        <meta http-equiv="refresh" content="1;url={{ route('qc.pemesanan.index') }}">
    @endif

    <h2 class="text-2xl font-bold mb-6 text-gray-800">Daftar Pemesanan</h2>

    {{-- Search dan Filter --}}
    <div class="mb-6 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <form action="{{ route('qc.pemesanan.index') }}" method="GET" class="space-y-4">
    ...
    {{-- ================= MODERN MOBILE VIEW (CARD) ================= --}}
    <div class="space-y-6 md:hidden px-2">
        @forelse($pesanans as $pemesanan)
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all hover:shadow-md">
                ...
                <div class="flex border-t border-gray-100 bg-gray-50/50 p-3 gap-3">
                    <a href="{{ route('qc.pemesanan.show', $pemesanan->pemesanan_id) }}" class="flex-1 inline-flex justify-center items-center px-4 py-2.5 bg-blue-600 border border-gray-200 text-white font-bold rounded-xl text-sm transition-all hover:bg-blue-800 active:scale-95 shadow-sm">
                    Detail
                    </a>
                </div>
            </div>
            ...
            <tbody>
                @forelse($pesanans as $pemesanan)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('qc.pemesanan.show', $pemesanan->pemesanan_id) }}"
