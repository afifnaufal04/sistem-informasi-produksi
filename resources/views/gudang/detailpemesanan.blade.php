...
<div class="mx-2 flex justify-start space-x-2 mb-4">
    ...
    <a href="{{ route('gudang.pemesanan.downloadspk', $pemesanan->pemesanan_id) }}" 
        class="bg-red-500 hover:bg-red-700 text-white font-medium px-4 py-2 rounded shadow">
        Download SPK
    </a>

    <form action="{{ route('gudang.pemesanan.konfirmasi', ['id' => $pemesanan->pemesanan_id, 'bagian' => 'gudang']) }}" method="POST">
        @csrf
    ...
    <footer class="block lg:hidden mt-12 text-sm">
        <div class="grid grid-cols-2 gap-y-10 text-center">
            ...
            <div>
                ...
                @if($pemesanan->konfirmasi_marketing)
                    <img src="{{ asset('assets/images/TTD_Marketing.png') }}" class="mx-auto" width="90">
                @else
                    <p>(...........................)</p>
                @endif
            ...
            <div>
                ...
                @if($pemesanan->konfirmasi_ppic)
                    <img src="{{ asset('assets/images/TTD_PPIC.png') }}" class="mx-auto" width="90">
                @else
                    <p>(...........................)</p>
                @endif
            ...
            <div class="col-span-2">
                ...
                @if($pemesanan->konfirmasi_keprod)
                    <img src="{{ asset('assets/images/TTD_Keprod.png') }}" class="mx-auto" width="90">
                @else
                    <p>(...........................)</p>
                @endif
                <p class="font-semibold mt-2">Manajer Operasional</p>
